...
/* list-tugas.html */
class __TwigTemplate_3de3e203632778dc5fc19110fedaefbd19fc102a8634b2788c595e48611ac4e6 extends Twig_Template
{
    ...
    <div class=\"module-body\">
        ...
        if ((is_siswa() == false)) {
            ...
            echo "            <div class=\"btn-group pull-right\" style=\"margin-top:-5px;\">
                ";
            // line 18
            echo anchor("plugins/custom_tugas/add/3", "Tambah Tugas Ganda", array("class" => "btn btn-primary"));
            echo "
                ";
            // line 19
            echo anchor("plugins/custom_tugas/add/2", "Tambah Tugas Essay", array("class" => "btn btn-primary"));
            echo "
                ";
            // line 20
            echo anchor("plugins/custom_tugas/add/1", "Tambah Tugas Upload", array("class" => "btn btn-primary"));
            echo "
                ";
            // line 21
            echo anchor("plugins/bank_soal", "Bank Soal", array("class" => "btn btn-success"));
            echo "
            </div>
            ";
        }
        ...
        foreach ($context['_seq'] as $context["no"] => $context["m"]) {
            ...
            if ((is_siswa() == false)) {
                ...
                echo "
                            ";
                // line 185
                echo anchor(((("plugins/custom_tugas/edit/" . $this->getAttribute((isset($context["m"]) ? $context["m"] : null), "id")) . "/") . enurl_redirect(current_url())), "<i class=\"icon-edit\"></i> Edit", array("class" => "btn btn-default btn-small"));
                echo "
                            ";
                // line 186
                ...
                if (($this->getAttribute((isset($context["m"]) ? $context["m"] : null), "aktif") == 1)) {
                    ...
                    if ((sudah_ngerjakan($this->getAttribute((isset($context["m"]) ? $context["m"] : null), "id"), get_sess_data("user", "id")) == false)) {
                        // line 194
                        echo "                                    ";
                        echo anchor(("plugins/custom_tugas/kerjakan/" . $this->getAttribute((isset($context["m"]) ? $context["m"] : null), "id")), "<i class=\"icon-ok-sign\"></i> Mulai Kerjakan", array("class" => "btn btn-success btn-small", "onclick" => "return confirm('Anda yakin ingin memulai mengerjakan tugas ini?')"));
                        echo "
                                ";
                    }
                    // line 196
