...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
        ...
        'id':
        {
            ...
            'week-7' : 'mg',
            'week-number': 'W',
            'month-name': ['januari','februari','maret','april','mai','juni','juli','agustus','september','oktober','november','desember'],
            'shortcuts' : 'Shortcuts',
            'custom-values': 'Ubah Isi',
            'past': 'Past',
            'following':'Following',
            'previous' : 'Sebelumnya',
            'prev-week' : 'Minggu',
            ...
            'next-month':'Bulan',
            'next-year':'Tahun',
            'less-than' : 'Rentang tanggal tidak boleh lebih dari %d hari',
            'more-than' : 'Rentang tanggal tidak boleh kurang dari %d hari',
            'default-more' : 'Silakan pilih rentang tanggal lebih lama dari %d hari',
            'default-single' : 'Silakan pilih tanggal',
            'default-less' : 'Silakan pilih rentang tanggal kurang dari %d hari',
            'default-range' : 'Silakan pilih rentang tanggal antara %d dan %d hari',
